...
public class BottomSheetBehavior2<V extends View> extends CoordinatorLayout.Behavior<V> {
    ...
    public void onNestedPreScroll(CoordinatorLayout coordinatorLayout, V child, View target, int dx,
                                  int dy, int[] consumed) {
        if (null == mNestedScrollingChildRef) {
            return;
        }
    ...
    void setStateInternal(@BottomSheetBehavior2.State int state) {
        ...
        mState = state;
        View bottomSheet = mViewRef != null ? mViewRef.get() : null;
    ...
    private final ViewDragHelper.Callback mDragCallback = new ViewDragHelper.Callback() {
        ...
        public boolean tryCaptureView(View child, int pointerId) {
            ...
            if (mTouchingScrollingChild || null == mNestedScrollingChildRef) {
                return false;
            }
    ...
    protected static class SavedState extends AbsSavedState {
        ...
        public SavedState(Parcelable superState, @BottomSheetBehavior2.State int state) {
            super(superState);
            this.state = state;
        }
